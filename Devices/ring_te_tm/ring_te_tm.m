...
set('width',w1);
set('y span',wg_h);
set('start angle',theta_span/2-ldc0/R1*180/pi);
set('span angle',ldc0/R1*180/pi);


R3_z = (R1-R3)*cos(theta_span/2*pi/180-ldc0/R1);
R3_x = (R1-R3)*sin(theta_span/2*pi/180-ldc0/R1);
addarcwaveguide();
set('name','dc1_R3');
set('x',-R3_x);
set('y',y0);
...
set('width',w1);
set('y span',wg_h);
set('start angle',-(180-(theta_span/2-ldc0/R1*180/pi)));
set('span angle',180);
